...
from backend.core.scoring_core import compute_dependency_risk
...
class TestDependencyRisk(unittest.TestCase):
    ...
    def test_empty_dependencies(self):
        ...
        score, issues = compute_dependency_risk(snapshot)
        self.assertEqual(score, 0)
        self.assertEqual(issues, [])

    def test_low_risk_repo(self):
    ...
    def test_many_dependencies_risk(self):
        ...
        self.assertIn("many_dependencies", issues)

    def test_unpinned_dependencies_risk(self):
        """핀 고정 비율이 낮은 경우"""
        ...
        self.assertIn("unpinned_dependencies", issues)
