...
const StructureVisualization = ({ visualization }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 뷰 모드 토글 (다이어그램과 트리 둘 다 있을 때) */}
      {mermaid_diagram && ascii_tree && (
      ...
      {/* Mermaid 다이어그램 */}
      {viewMode === "diagram" && mermaid_diagram && (
        <MermaidDiagram
